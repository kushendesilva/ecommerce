...
<p align="center"><em>An Ecommerce Website..<img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30"> 
</em></p>
...
- Import `db_shop.sql` to your local SQL database server.[^1]
